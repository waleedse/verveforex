              ...
              <div className="bg-body p-3 mt-3 rounded">
                <div className="mt-3 row align-items-center">
                  ...
                  <div className="col-5">
                    ...
                    <p className="text-warning mb-0"><i className="ti ti-arrow-up-right" /> 30.6%</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="card">
            ...
            <div className="card-body">
              ...
              <div className="d-grid gap-2">
                <a href="#" className="btn btn-link-secondary">
                  <div className="d-flex align-items-center">
                    ...
                    <div className="badge bg-light-secondary f-12"><i className="ti ti-paperclip text-sm" /> 2</div>
                  </div>
                </a>
                <a href="#" className="btn btn-link-secondary">
                  <div className="d-flex align-items-center">
              ...
              <div className="d-grid mt-3">
                <button className="btn btn-primary d-flex align-items-center justify-content-center"><i className="ti ti-plus" /> Add task</button>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="row align-items-center justify-content-center">
                ...
                <div className="col-md-6 col-xl-4">
                  <div className="mt-3 d-grid">
                    <button className="btn btn-primary d-flex align-items-center justify-content-center"><i className="ti ti-plus" /> Add project</button>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="card-body border-bottom pb-0">
              ...
              <ul className="nav nav-tabs analytics-tab" id="myTab" role="tablist">
                <li className="nav-item" role="presentation">
                  <button className="nav-link active" id="analytics-tab-1" data-bs-toggle="tab" data-bs-target="#analytics-tab-1-pane" type="button" role="tab" aria-controls="analytics-tab-1-pane" aria-selected="true">All Transaction</button>
                </li>
                <li className="nav-item" role="presentation">
                  <button className="nav-link" id="analytics-tab-2" data-bs-toggle="tab" data-bs-target="#analytics-tab-2-pane" type="button" role="tab" aria-controls="analytics-tab-2-pane" aria-selected="false">Success</button>
                </li>
                <li className="nav-item" role="presentation">
                  <button className="nav-link" id="analytics-tab-3" data-bs-toggle="tab" data-bs-target="#analytics-tab-3-pane" type="button" role="tab" aria-controls="analytics-tab-3-pane" aria-selected="false">Pending</button>
                </li>
              </ul>
            </div>
              ...
              <div className="tab-pane fade show active" id="analytics-tab-1-pane" role="tabpanel" aria-labelledby="analytics-tab-1" tabIndex={0}>
                <ul className="list-group list-group-flush">
                      ...
                      <div className="flex-grow-1 ms-3">
                        <div className="row g-1">
                          ...
                          <div className="col-6 text-end">
                            ...
                            <p className="text-danger mb-0"><i className="ti ti-arrow-down-left" /> 10.6%</p>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <li className="list-group-item">
                    <div className="d-flex align-items-center">
                      <div className="flex-shrink-0">
                        <div className="avtar avtar-s border" data-bs-toggle="tooltip" data-bs-title="10,000 Tracks"><span>SM</span></div>
                      </div>
                      <div className="flex-grow-1 ms-3">
                        <div className="row g-1">
                          <div className="col-6">
                  ...
                  <li className="list-group-item">
                    <div className="d-flex align-items-center">
                      <div className="flex-shrink-0">
                        <div className="avtar avtar-s border bg-light-primary" data-bs-toggle="tooltip" data-bs-title="143 Posts"><span>MD</span>
                        </div>
                      </div>
                      <div className="flex-grow-1 ms-3">
                        <div className="row g-1">
                  ...
                  <li className="list-group-item">
                    <div className="d-flex align-items-center">
                      <div className="flex-shrink-0">
                        <div className="avtar avtar-s border" data-bs-toggle="tooltip" data-bs-title="143 Posts"><span>U</span> </div>
                      </div>
                      <div className="flex-grow-1 ms-3">
                        <div className="row g-1">
                          <div className="col-6">
                  ...
                  <li className="list-group-item">
                    <div className="d-flex align-items-center">
                      <div className="flex-shrink-0">
                        <div className="avtar avtar-s border bg-light-warning" data-bs-toggle="tooltip" data-bs-title="143 Posts"><span>OC</span>
                        </div>
                      </div>
                      <div className="flex-grow-1 ms-3">
                        <div className="row g-1">
              ...
              <div className="row g-2">
                <div className="col-md-6">
                  <div className="d-grid">
                    <button className="btn btn-outline-secondary d-grid"><span className="text-truncate w-100">View all Transaction History</span></button>
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="d-grid">
                    <button className="btn btn-primary d-grid"><span className="text-truncate w-100">Create new Transaction</span></button>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="row g-3 mt-3">
                <div className="col-sm-6">
                  <div className="bg-body p-3 rounded">
                    ...
                    <h6 className="mb-0">$23,876 <small className="text-muted"><i className="ti ti-chevrons-up" /> +$763,43</small></h6>
                  </div>
                </div>
                <div className="col-sm-6">
                  <div className="bg-body p-3 rounded">
