        ...
        <Fragment>
            ...
            <ul className="static-li" style={{ padding: "30px 150px", color: "Black" }}>
                ...
                <li><strong>2.</strong> <strong>Use of Website:</strong>
                    <ul>
                        <li><strong>2.1.</strong> You may use the Website for lawful purposes only.</li>
                        <li><strong>2.2.</strong> You agree not to engage in any activity that disrupts or interferes with the functioning of the Website or its services.</li>
                    </ul>
                </li>
                ...
                <li><strong>4.</strong> <strong>User Accounts:</strong>
                    <ul>
                        <li><strong>4.1.</strong> To access certain features of the Website, you may be required to create a user account.</li>
                        <li><strong>4.2.</strong> You are responsible for maintaining the confidentiality of your account credentials and for all activities that occur under your account.</li>
                    </ul>
                </li>
                <li><strong>5.</strong> <strong>Privacy:</strong>
                    <ul>
                        <li><strong>5.1.</strong> Your use of the Website is subject to our Privacy Policy, which governs the collection, use, and disclosure of your personal information.</li>
                    </ul>
                </li>
                ...
                <li><strong>9.</strong> <strong>Governing Law and Jurisdiction:</strong>
                    <ul>
                        <li><strong>9.1.</strong> These Terms and Conditions shall be governed by and construed in accordance with the laws of United Kingdom.</li>
                        <li><strong>9.2.</strong> Any disputes arising under these Terms shall be subject to the exclusive jurisdiction of the courts of United Kingdom.</li>
                    </ul>
                </li>
                ...
                <li><strong>11.</strong> <strong>Sever-ability:</strong>
                    <ul>
                        <li><strong>11.1.</strong> If any provision of these Terms and Conditions is found to be invalid or unenforceable, that provision shall be deemed severable from the rest of the Terms, and the remaining provisions shall remain in full force and effect.</li>
                    </ul>
                </li>
