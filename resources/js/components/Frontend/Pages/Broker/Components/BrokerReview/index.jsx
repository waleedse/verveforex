                    ...
                    <div className="col-lg-6 col-md-6 col-sm-12 single-column">
                        <div className="single-item">
                            <div className="icon-box">
                                ...
                                <div className="icon"><img src="assets/images/icons/picture1.png" alt /></div>
                            </div>
                            <div className="title-text"><h3>Swap Free Account</h3></div>
                            <p>Swap Free Accounts are available to all our clients</p>
                        </div>
                    </div>
                    <div className="col-lg-6 col-md-6 col-sm-12 single-column">
                        <div className="single-item">
                            <div className="icon-box">
                                <div className="shape" style={{ backgroundImage: 'url(assets/images/shape/shape-44.png)' }} />
                                <div className="icon"><img src="assets/images/icons/give-money.png" alt /></div>
                            </div>
                            <div className="title-text"><h3>Fast Deposit withdrawal </h3></div>
                            <p>Fast Deposit & Withdrawal Service</p>
                        </div>
                    </div>
                    <div className="col-lg-6 col-md-6 col-sm-12 single-column">
                        <div className="single-item">
                            <div className="icon-box">
                                <div className="shape" style={{ backgroundImage: 'url(assets/images/shape/shape-44.png)' }} />
                                <div className="icon"><img src="assets/images/icons/translator.png" alt /></div>
                            </div>
                            <div className="title-text"><h3>Lowest Spread</h3></div>
                            <p> Spreads are lowest in the market</p>
                        </div>
                    </div>
                    <div className="col-lg-6 col-md-6 col-sm-12 single-column">
                        <div className="single-item">
                            <div className="icon-box">
                                <div className="shape" style={{ backgroundImage: 'url(assets/images/shape/shape-44.png)' }} />
                                <div className="icon"><img src="assets/images/icons/loss.png" alt /></div>
                            </div>
                            <div className="title-text"><h3>24/5 Multilingual customer service</h3></div>
                            <p>Offer personalised customer service round the clock</p>
                        </div>
                    </div>
                </div>
            </div>
