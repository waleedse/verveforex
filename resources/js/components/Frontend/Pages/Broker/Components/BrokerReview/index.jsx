            ...
            <div className="col-lg-8 col-md-12 col-sm-12 content-side">
                <div className="account-details-content">
                    <div className="text-box">
                        ...
                        <p>Cabana Capital operates as a forex licensed broker . Since its inception, it has furnished traders with a dependable and effective platform for forex, commodities, indices, and cryptocurrency trading. Through its extensive array of trading instruments, traders can diversify their portfolios and capitalise on market opportunities.A notable aspect of Cabana Capital is its provision of high leverage, reaching up to 1:500. Nonetheless, the broker offers favourable trading conditions to enable traders to execute their strategies proficiently.Cabana Capital presents four distinct types of trading accounts: Cent, Standard, Ultra and Elite accounts. Each account category boasts unique features and prerequisites, empowering traders to select the account that aligns with their trading preferences. For instance, the Cent account caters to beginners seeking to initiate trading with a modest capital, while the Standard and Ultra accounts cater to seasoned traders willing to engage with larger capital amounts.Moreover, Cabana Capital facilitates demo accounts for traders keen on honing their strategies and financial risk. Additionally, Islamic accounts are available for traders adhering to Sharia law.The broker's dedicated support team operates 24/5, ensuring prompt assistance for clients with any queries or concerns. Furthermore, the trading platform is accessible in multiple languages, enhancing accessibility for traders across the globe.
                        </p>
                    </div>
