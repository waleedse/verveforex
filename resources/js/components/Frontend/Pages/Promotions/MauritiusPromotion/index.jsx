            ...
            <div className='trip-details row'>
                ...
                <div className='trip-description col-md-6 '>
                    ...
                    <ul className='px-5'>
                        ...
                        <li> Qondzo will not cover additional expenses such as meals, personal
            ...
            <div className='trip-details row'>
                ...
                <div className='trip-description col-md-6'>
                    ...
                    <ul>
                        ...
                        <li>
                            <p>As part of this great offer, Qondzo also gives you an opportunity to combine the above number of lots over multiple brokers e.g.</p>
                            <ul>
                                <li>If you trade 400 lots with Cabana Capitals and 200 lots with OctaFx, you can still avail this offer. Please note that the accounts you are using for this offer are as per the account types listed above and also the Introducing Broker on your profile must be Qondzo under all the Broker’s you will be using.</li>
                            </ul>
                        </li>
                    </ul>
