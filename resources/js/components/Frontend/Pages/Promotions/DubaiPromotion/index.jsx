        ...
        <section className='promotion-wrapper'>
            ...
            <div className="container">
                <div className="promotion-heading">
                    ...
                    <p className='text-center'> Embark on an extraordinary journey to Dubai</p>
                </div>
                ...
                <p className='promotion-details'>
                    Embark on an extraordinary journey to Dubai, where opulence meets opportunity with our exclusive trip as part of your forex trading. Prepare to immerse yourself in the lavish lifestyle of the city while exploring lucrative trading possibilities in one of the world's most dynamic financial hubs.
                </p>
                <p className='promotion-details'>
                    Your adventure begins with a warm welcome to Dubai, where you'll be accommodated in luxurious surroundings, providing the perfect blend of comfort and sophistication. Whether it's a sleek high-rise hotel offering stunning views of the city skyline or a lavish resort nestled along pristine beaches, your stay promises to be nothing short of extraordinary.
                </p>
                <p className='promotion-details'>
